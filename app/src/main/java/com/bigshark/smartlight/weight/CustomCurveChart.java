...
public class CustomCurveChart extends View {
    ...
    public void init() {
        ...
        paintAxes.setColor(ContextCompat.getColor(getContext(), R.color.white));
        ...
        paintValue.setColor(ContextCompat.getColor(getContext(), R.color.color4));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.tongming));
        init();
